"""Evaluate and export a trained reprojection student checkpoint."""
...
from train_reprojection_student import (
    ReprojectionStudent,
    TeacherDataset,
    compute_loss,
    export_prediction,
...
def main() -> None:
    ...
    parser.add_argument("--teacher", type=Path, default=ROOT / "runs/teacher_moge3_demo_384")
    ...
    config = state["config"]
    model = ReprojectionStudent(width=int(config["width"])).to(device)
